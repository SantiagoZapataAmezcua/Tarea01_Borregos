...
Existen casos que evidencian la valoración económica de los datos. En 2014, Shawn Buckles subastó su información personal —desde datos básicos hasta sus preferencias e historial de navegación— y obtuvo £288, en contraste con los \$0.0005 dólares que pagan los anunciantes por datos básicos y genéricos. Esto muestra la diferencia abismal entre la información superficial y la información detallada. Asimismo, se señala que compañías como Google obtuvieron en 2014 ganancias de hasta 45 dólares por usuario gracias a la publicidad, y que hacia 2020 las aplicaciones basadas en datos podrían generar hasta 330 billones de euros en beneficios. Otros estudios, como los de Staiano en 2014, estiman que los usuarios valoran su información en un promedio de 2 euros, mientras que una encuesta de 2016 reveló que este valor ascendía a £3,241.\\
En la parte final del texto, se enfatiza la importancia de la protección de los datos personales en el contexto del crecimiento del Big Data y el IoT. Se destacan iniciativas como el proyecto Hub of All Things, que busca devolver a los usuarios el control de su propia información mediante plataformas digitales donde ellos mismos gestionan y deciden con quién compartir sus datos y con qué fines. En este mismo sentido, se aborda la intervención de la Unión Europea, que a través del Reglamento General de Protección de Datos (GDPR) ha establecido un marco regulatorio único para garantizar la protección de los datos personales, reconociendo que estos se han convertido en un activo económico fundamental.\\
Finalmente, para dar cierre, se afirma que los datos no pueden considerarse neutrales, pues reflejan nuestra relación con el entorno. Por ello, se subraya la necesidad de que las personas gestionen sus datos de manera consciente y responsable, fomentando la creación de Personal Data Stores (PDS) como una vía para empoderar a los individuos y promover un entorno más justo, donde el valor de la información no quede concentrado únicamente en las empresas, sino que también pueda beneficiar directamente al usuario.
