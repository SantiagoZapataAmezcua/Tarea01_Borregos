...
\begin{itemize}
    ...
    \begin{itemize}
        \item Las bases de datos aplican reglas de integridad (claves primarias, restricciones) que evitan duplicados o inconsistencias en los datos.
        \item Las hojas de cálculo dependen de que el usuario mantenga fórmulas y datos correctos, lo que facilita errores humanos.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Las hojas de cálculo solo ofrecen protecciones básicas de celdas o contraseñas.
    \end{itemize}
\end{itemize}
